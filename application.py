...
keyword_dict = {'keyword 1':'movies','keyword 2':'technology','keyword 3':'sports','keyword 4':'life','keyword 5':'news','keyword 6':'travel','keyword 7':'health','keyword 8':'awesome','keyword 9':'energy','keyword 10':'music','Nothing here':'','':''}
...
def getgeotweets(latitude, longitude, distance):
    ...
    body = {"query": {"match_all": {}}, "filter": {"geo_distance": { "distance": distance_string, "distance_type": "sloppy_arc", "location": { "lat": latitude, "lon": longitude 	}}}}

    size = 10000
    result = es.search(index = "final-tweet-index", doc_type = "twitter", body, size)
